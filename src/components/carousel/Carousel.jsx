...
const CarouselComponent = () => {
   return (
      <Carousel autoPlay infiniteLoop>
         ...
         <div>
            <img src={require("../../assets/img/AmigosBrindandoComGarrafa.png")} alt=""/>
         </div>
         <div>
            <img src={require("../../assets/img/AmigosConfraternizando.png")} alt=""/>
         </div>
         <div>
            <img src={require("../../assets/img/AmigosDepoisDoTrabalho.png")} alt=""/>
         </div>
         <div>
         ...
         <div>
            <img src={require("../../assets/img/BrindeAmigosReunidos.png")} alt=""/>
         </div>
         <div>
